...
import "../../css/alarm/ManageAlarm.css";
    ...
    <div className="Manage-container">
      ...
      <section className="Manage-contents Manage-contents-table">
        ...
        <div className="manage-table-container">
          <div className="Manage-alarm-search-container">
            <div className="Manage-alarm-search-number">
              <span>전체 갯수</span>
              <span>000</span>
            </div>
            <div className="Manage-alarm-search">
              <div>
                <input
          ...
          <div className="Manage-table manage-table-alarm">
            <table>
              <thead>
                <tr>
                  <th>No</th>
